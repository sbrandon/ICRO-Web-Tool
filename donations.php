<?php    
 ...
 echo "<div class='newstitle'>ICRO - Donations</div>";
...
<br/><br/>
There is no organisation in the country that hasn't been affected by the recession and in ICRO's case, its 2011 funding was reduced by &euro;12,000. While challenging, this has has not deterred the organisation and despite the funding cuts, it continues to provide an expert emergency rescue service. But such a service needs to be maintained and that is where your help comes in.
<br/><br/>
...
<input type="hidden" name="hosted_button_id" value="JW322KLMU3U3J">
